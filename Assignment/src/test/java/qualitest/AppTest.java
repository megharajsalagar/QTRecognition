...
public class AppTest extends App
{
	...
	public void homePageColors() {
		...
		try {
			...
			//Validation of colors using Assertions
			...
			logger.error("Error in matching colors: "+e.getMessage());
		}
	}
	...
	public void login3() throws InterruptedException {
		...
		try {
			...
			logger.error("Error in matching employee name: "+e.getMessage());;
		}
	}
	...
	public void seeKudosFromMe() throws InterruptedException {
		try {
			...
			logger.error("Error in getting search result in from me section: "+e.getMessage());
		}
	}
	...
	public void seeKudosToMe() throws InterruptedException {
		try {
			...
			logger.error("Error in getting search result in to me section: "+e.getMessage());
